    ...
    <div class="whole">
		...
		<div class="main">
			...
			<div class="right">
				...
				<div class="title">借出与归还管理->->借出资产</div>
				<hr>
				<br/>
  				<br/>
  				<br/>
				<form action="admin_op_doLendAsset.action" method="post" >
		  			<table>
		  				<div class="title">借出资产</div>
		  				<tr>
		  					<td>资产编号：</td>
		  					<td>
		  				...
		  				<tr>
		  					...
		  					<td>员工说明：</td>
		  					<td><input type="text" id="empInfo" name="empInfo"></td>
		  				</tr>
		  				<tr>
		  					<td>备注：</td>
		  				...
		  				<tr>
		  					<td></td>
		  					<td><input type="submit" value="确定借出"/></td>
		  					<td></td>
		  				</tr>
		  			</table>
  				</form>
